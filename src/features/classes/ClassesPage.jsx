          ...
          {classesData.map((classes, i) => (
            i % 2 === 0 ? (
              <div key={i} style={{ display: 'flex'}}>
                <Grid item md={6} xl={6} padding="3%" backgroundColor='gray'>
                  <div style={{ display: 'flex', flexWrap: 'wrap'}}>
                    <Typography variant="title" align="center" color="black">
                      {classes.name}
                    </Typography>

                    <Typography variant="body" align="justify" color="black" backgroundColor="gray">
                      {classes.description}
                    </Typography>
              ...
              <div key={i} style={{ display: 'flex' }}>
                ...
                <Grid key={i} item md={6} xl={6} padding="3%" backgroundColor="white">
